...
#        self.printout('UDC'+str(last_currency_balence)+','+self.coin_name+str(last_coin_balence))
#        self.fillPriceList()
#        self.printout('init finish')
#    
...
#                self.printout('stopLoss')
#                self.closePosition(bid1)
#                self.printout('Profit is '+str(self.closeprice/self.buyprice - 1))
#                self.status = 'out'
#            elif ask1/self.buyprice > 1 +self.stopprofit:
#                self.printout('stopProfit')
...
#                self.printout('meanprice'+str(self.buyprice)+'long'+str(self.vol)+' ')
#                break
#            elif i == 0:
#                self.wmex.order_cancel(OrderId)
#                self.volreal = report['tradedNumber']
#                self.buyprice = report['matchedMoney']/report['tradedNumber']
#                self.printout('meanprice'+str(self.buyprice)+'long'+str(self.volreal)+' ')
#                break
#            
...
#                self.buyprice = report['matchedMoney']/report['tradedNumber']
#                self.printout('meanprice'+str(self.buyprice)+'short'+str(self.volreal)+' ')
#                break
#            else:
#                self.wmex.order_cancel(OrderId)
#                allprice = allprice + report['matchedMoney']
#                vol = vol + report['tradedNumber']
#                self.buyprice = report['matchedMoney']/report['tradedNumber']
#                self.printout('meanprice'+str(self.buyprice)+'short'+str(self.vol)+' ')
